# -*- coding: utf-8 -*-
"""Text_to_3DModelGenerator.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1h1ccIRo4n_OFwl0s6lC3taIYg4tN_X4B
"""
...
prompt = "a red shark" # this is the prompt, you can change this to anything you want.
...
for i, latent in enumerate(latents):
    ...
    with open(f'example_mesh_{i}.ply', 'wb') as f: # this is three-dimensional geometric data of model.
        t.write_ply(f)
    with open(f'shark_mesh_{i}.obj', 'w') as f: # we will use this file to customize in Blender Studio later.
        t.write_obj(f)